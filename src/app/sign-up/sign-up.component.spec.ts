...
describe('SignUpComponent', () => {
  ...
  describe('Layout', () => {
    ...
    it('has email input', () => {
      ...
      const input = signUp.querySelectorAll('input[id="email"]');
      expect(input).toBeTruthy();
    ...
    it('has password input', () => {
      ...
      const input = signUp.querySelectorAll('input[id="password"]');
      expect(input).toBeTruthy();
      //expect(inputs.length).toBe(2);
      //expect(input).toBeTruthy();
      expect(label).toBeTruthy();
    ...
    it('has password repeat input', () => {
      ...
      const input = signUp.querySelectorAll('input[id="passwordRepeat"]');
      expect(input).toBeTruthy();
      //expect(inputs.length).toBe(2);
      //expect(input).toBeTruthy();
      expect(label).toBeTruthy();
  ...
  describe('Interactions', () => {
    ...
    it('displays account activation notification after successful sign up request', () => {
      ...
      expect(message?.textContent)
        .toContain('Please check your email to activate your account');
    });
